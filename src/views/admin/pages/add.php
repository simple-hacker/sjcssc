...
<div class="wrap">
    <h3>Add Page</h3>
    <form action="<?php echo ADMIN_URLROOT . $data['club']->club . '/pages/add' ; ?>" method="POST">
        <div class="form-group row">
            <label for="page" class="col-sm-2 col-form-label d-none d-md-flex">Page Name</label>
            <div class="col-12 col-md-10">
                <input type="text" name="page" class="form-control<?php if (!empty($data['page_err'])) echo ' is-invalid'; ?>" placeholder="Enter Page Name" value="<?php echo (isset($data['page']->page)) ? $data['page']->page : ''; ?>"/>
        ...
        <div class="form-group row mt-5">
            <div class="col-6 mx-auto text-center">
                <input type="submit" id="save" value="Add Page" class="btn btn-brown btn-block" onClick="saveHTML();">
            </div>
        </div> 
    </form>
</div>
