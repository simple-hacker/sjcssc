...
?>
    ...
    <form action="<?php echo ADMIN_URLROOT . $data['club_name'] . '/settings/leagues'; ?>" method="POST">
        ...
        <input type="text" name="league[]" value="" placeholder="Add League"/>
        <input type="text" name="league_full[]" value="" placeholder="Add League Location"/>
        <input type="text" name="league_website[]" value="" placeholder="Add League Website"/>
